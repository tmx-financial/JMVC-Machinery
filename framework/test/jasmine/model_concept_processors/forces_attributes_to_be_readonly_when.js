...
(function(GLOBAL, undefined) {
    ...
    describe("The concept processor for forcesAttributesToBeReadonlyWhen", function() {
        var md;
        ...
        it("should exist", function() {
            var processor = n.newProcessorFor("forcesAttributesToBeReadonlyWhen", {});
        ...
        describe("cases when the syntax fed to it is valid", function() {
            ...
            beforeEach(function() {
                md = JmvcMachinery.Framework.ModelDefinition.newModelDefinition();
                p = n.newProcessorFor("forcesAttributesToBeReadonlyWhen", md);
            });
            ...
            it("should process one blurb correctly", function() {
                ...
                expect(result.mapTargetAttrsToConditionList.getConditionsFor("applicantFirstName")[0].condition).toEqual(blurb.forcesAttributesToBeReadonlyWhen.applicantFirstName[0].condition);
            ...
            it("should build its data structures correctly when fed multiple blurbs", function() {
                ...
                _(blurbs).each(function(b) {
                    var o = { forcesAttributesToBeReadonlyWhen: b };
